...
import (
	...
	"github.com/helloandworlder/sx-ui/v2/web/controller"
	"github.com/helloandworlder/sx-ui/v2/web/job"
...
type Server struct {
	...
	restApi *controller.RestAPIController
...
func (s *Server) initRouter() (*gin.Engine, error) {
	...
	s.restApi = controller.NewRestAPIController(g)
