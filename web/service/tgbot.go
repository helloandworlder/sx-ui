...
import (
	...
	"github.com/helloandworlder/sx-ui/v2/web/global"
...
func normalizeTelegramUserID(raw string) int64 {
	trimmed := strings.TrimSpace(raw)
	if trimmed == "" {
		return EmptyTelegramUserID
	}
...
func (t *Tgbot) BuildJSONForProtocol(protocol model.Protocol) (string, error) {
	...
	tgID := normalizeTelegramUserID(client_TgID)
